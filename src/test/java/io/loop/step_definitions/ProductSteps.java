...
//            System.out.println("expectedPrice = " + productDetail.get("expectedPrice"));
            ...
            LOG.info("Valiidation of the price for: " + productDetail.get("Category") + ", for Product: " + productDetail.get("Product") + ", actual: " + actualPrice);
        }
    }
    ...
    public void user_should_be_able_to_see_expected_prices_in_the_following_products_with_list_of_lists(List<List<String>> productDetails) {
        for (List<String> productDetail : productDetails) {
            ...
            // Get the expected price from feature file
            String expectedPrice = productDetail.get(2);
            // Assertion
            assertEquals("Expected does not match the actual", expectedPrice, actualPrice);
            LOG.info("Validation of the price for: " + productDetail.get(0) + ", for Product: " + productDetail.get(1) + ", actual: " + actualPrice);
        }
    }
